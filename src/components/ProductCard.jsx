...
function ProductCard() {
  return (
    <section className="md:w-[277px] md:h-[367px] md:bg-white md:p-2 md:rounded-md">
      ...
      <article className="md:mt-[5px]">
        <div className="md:flex md:justify-between md:pl-2 md:pr-4 md:pt-2.5 ">
          <h1 className=" md:text-[20px] md:tracking-wide">Grill Sandwich</h1>
          <h3 className=" md:text-[20px] md:text-[#FA9564]">$30</h3>
        </div>
